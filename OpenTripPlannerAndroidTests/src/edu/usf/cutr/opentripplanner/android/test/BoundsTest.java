...
public class BoundsTest extends AndroidTestCase {
	...
	protected void setUp() throws Exception {
		...
		serverGreenville.setBaseURL("http://trip.greenvilleopenmap.info/opentripplanner-api-webapp/ws");
		...
		serverCalgary.setBaseURL("http://gisciencegroup.ucalgary.ca:8080/opentripplanner-api-webapp/ws");
	...
	public void testBoundsEvaluation(){
		...
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInPortland1, serverPortland, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfPortland1 = new LatLng(45.416, -122.939);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfPortland1, serverPortland, ACCEPTABLE_ERROR));
		
		
		// Greenville server
		LatLng pointInGreenville1 = new LatLng(34.84733, -82.39693);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInGreenville1, serverGreenville, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfGreenville1 = new LatLng(45.416, -122.839);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfGreenville1, serverGreenville, ACCEPTABLE_ERROR));
		
		
		// Calgary server
		LatLng pointInCalgary1 = new LatLng(50.7100302, -114.6108674);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInCalgary1, serverCalgary, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfCalgary1 = new LatLng(45.416, -122.839);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfCalgary1, serverCalgary, ACCEPTABLE_ERROR));
		
		
		// Porto server
		LatLng pointInPorto1 = new LatLng(41.1554, -8.6078);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInPorto1, serverPorto, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfPorto1 = new LatLng(45.416, -122.839);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfPorto1, serverPorto, ACCEPTABLE_ERROR));
		
		
		// Portland big bounds server
		LatLng pointInPortlandBigBounds1 = new LatLng(45.518,-122.6800);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInPortlandBigBounds1, serverPortlandBigBounds, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfPortlandBigBounds1 = new LatLng(27.9710, -82.4650);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfPortlandBigBounds1, serverPortlandBigBounds, ACCEPTABLE_ERROR));
		

		// FijiIDL server
		LatLng pointInFijiIDLPositive = new LatLng(-16.407,-179.8141);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInFijiIDLPositive, serverFijiIDL, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfFijiIDLPositive = new LatLng(-17.6995,175.6581);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfFijiIDLPositive, serverFijiIDL, ACCEPTABLE_ERROR));
		
		LatLng pointInFijiIDLNegative = new LatLng(-16.9089,-179.8151);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInFijiIDLNegative, serverFijiIDL, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfFijiIDLNegative = new LatLng(-16.5907, -178.8570);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfFijiIDLNegative, serverFijiIDL, ACCEPTABLE_ERROR));
		

		// ChukotkaPeninsulaIDL server
		LatLng pointInChukotkaPeninsulaIDLPositive = new LatLng(66.8878,179.1520);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInChukotkaPeninsulaIDLPositive, serverChukotkaPeninsulaIDL, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfChukotkaPeninsulaIDLPositive = new LatLng(-17.6995,175.6581);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfChukotkaPeninsulaIDLPositive, serverChukotkaPeninsulaIDL, ACCEPTABLE_ERROR));

		LatLng pointInChukotkaPeninsulaIDLNegative = new LatLng(67.2878,-179.7276);		
		Assert.assertTrue(LocationUtil.checkPointInBoundingBox(pointInChukotkaPeninsulaIDLNegative, serverChukotkaPeninsulaIDL, ACCEPTABLE_ERROR));
		
		LatLng pointOutOfChukotkaPeninsulaIDLNegative = new LatLng(67.2878,-178.7276);		
		Assert.assertFalse(LocationUtil.checkPointInBoundingBox(pointOutOfChukotkaPeninsulaIDLNegative, serverChukotkaPeninsulaIDL, ACCEPTABLE_ERROR));
	}	
}
